...
<div>
    ...
    <section>
        <div class="min-vh-75 mt-8">

            <div class="container my-5">
                <div class="row bg-white shadow-lg mt-n6 border-radius-md pb-4 p-3 mx-sm-0 mx-1 position-relative">
                    <div class="col-sm-9 mt-lg-n2 mt-2">
                        <label class="">Course</label>

                        <div class="input-group">
                            <input class="form-control form-control-alternative" placeholder="Please enter course name" type="text">
                        </div>

                    </div>
                    <div class="col-sm-3 d-flex align-items-center my-auto">
                        <button type="button" class="btn bg-gradient-dark w-100 btn-lg mb-0 m4 mt-3">Search</button>
                    </div>
                </div>
            </div>
            <div class="container">
                    ...
                    <div class="card">
                        <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                            <a href="javascript:;" class="d-block">
                                <img src="https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/laught.jpg" class="img-fluid border-radius-lg">
                            </a>
                        </div>
